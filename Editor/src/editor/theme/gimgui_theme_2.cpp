...
GImGuiTheme2::GImGuiTheme2()
{
	m_name = "Theme 2";
}

bool GImGuiTheme2::is_valid()
{
	return true;
}

const char* GImGuiTheme2::get_theme_name()
{
	return m_name.c_str();
}

void GImGuiTheme2::setImGuiTheme(ImGuiStyle& style)
{
...
bool GImGuiTheme2::init()
{
	return true;
}

void GImGuiTheme2::destroy()
{
}
