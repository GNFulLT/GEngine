...
void GImGuiTextEditorWindow::set_storage(GImGuiWindowStorage* storage)
{
	m_storage = storage;
}

bool GImGuiTextEditorWindow::need_render()
{
	return true;
}
...
void GImGuiTextEditorWindow::on_data_update()
{
}

const char* GImGuiTextEditorWindow::get_window_name()
{
	return m_name.c_str();
}
