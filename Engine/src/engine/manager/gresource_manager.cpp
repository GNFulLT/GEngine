...
std::expected<GResourcePtr, RESOURCE_ERROR> GResourceManager::create_resource(std::string_view name, std::string_view groupName, ResourceImplUniquePtr resourceImpl)
{
